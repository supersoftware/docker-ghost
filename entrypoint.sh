...
curl -SLO https://github.com/supersoftware/ghostium/archive/v2.4.3-custom.zip
unzip v2.4.3-custom.zip
mv ghostium-2.4.3-custom ghostium-custom
rm v2.4.3-custom.zip
cd /var/lib/ghost
